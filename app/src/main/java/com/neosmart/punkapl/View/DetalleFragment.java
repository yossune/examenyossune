...
public class DetalleFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        return  crearDialogoDetalle();//super.onCreateDialog(savedInstanceState);
    }

    private Dialog crearDialogoDetalle() {
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
        LayoutInflater inflater = getActivity().getLayoutInflater();
        View v =inflater.inflate(R.layout.fragment_detalle,null);
        builder.setView(v);
